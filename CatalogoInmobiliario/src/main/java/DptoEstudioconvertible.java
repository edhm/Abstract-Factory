 ...
 * @author JackStv
 */
public abstract class DptoEstudioconvertible {
    ...
    public DptoEstudioconvertible(float precio, String dpto, int nHabitaciones, int ndivisiones, int nPlanta, String color) {
        this.precio = precio;
        this.dpto = dpto;
